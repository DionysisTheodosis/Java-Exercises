...
public class CalendarPopUp  {
    //METAVLITES KLASHS
    private NewReservation mainPanel; //METAVLITI GIA TO MAINFRAME 
    ...
    private JFormattedTextField el; //METAVLITI GIA TO TEXTFIELD POU EMFANIZETAI H HMEROMHNIA
    ...
    //COSTRUCTOR O OPOIOS DEXETAI TO PANEL STO OPOIO THA VRISKETE ,TO PANEL THS HMEROMHNIAS WSTE NA EMFANISEI KONTA TO POPUP,KAI THN PRWTH MERA POUXEKINAEI H EPILOGH
      public CalendarPopUp(NewReservation mainPanel,JFormattedTextField el,Date firstDate){
    ...
    private void initComponents(){
        ...
        for(int i=0;i<42;i++){
            ...
            dayPanel.setPreferredSize(new Dimension(300,200));
        ...
        p = popF.getPopup(el,popUpPanel,cellPossition.x-50,cellPossition.y);//PROSTHIKI TOU POPUP STHN THESH TOU KELIOU 
        ...
        for (JButton i: day) {
            ...
            cell.addActionListener(new ActionListener(){//AN PATITHEI H HMERA
                ...
                public void actionPerformed(ActionEvent e) {//AN PATITHEI KAPOIO GRAMMA APO TO POPUP
                    ...
                    if(al.getTime().after(firstDate)){//AN TO KOUMPI EINAI META THS PRWTHS MERA TOTE MPOREI NA PATITHEI
